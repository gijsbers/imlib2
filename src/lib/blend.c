    ...
    static const ImlibBlendFunction ibfuncs[][4][2][2][2][2] = {
        ...
        { { { { { __imlib_mmx_copy_rgba_to_rgb, __imlib_mmx_blend_rgba_to_rgb},
         ...
         { { { { __imlib_mmx_add_copy_rgba_to_rgb,
              ...
              { __imlib_mmx_add_copy_rgb_to_rgb,
               __imlib_mmx_add_blend_rgb_to_rgb}},
         ...
         { { { { __imlib_mmx_reshade_copy_rgba_to_rgb,
            ...
            { { __imlib_ReCopyRGBAToRGBA
               /*__imlib_mmx_reshade_copy_rgba_to_rgba*/ ,
               __imlib_ReBlendRGBAToRGBA
...
#elif DO_AMD64_ASM
        /*\ OP_COPY \ */
        { { { { { __imlib_amd64_copy_rgba_to_rgb,
                 __imlib_amd64_blend_rgba_to_rgb},
               { __imlib_amd64_copy_rgb_to_rgb,
                __imlib_amd64_blend_rgb_to_rgb}},
             { { __imlib_amd64_copy_rgba_to_rgba,
                __imlib_amd64_blend_rgba_to_rgba},
